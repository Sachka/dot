...
function __promptline_ps1 {
  ...
  # section "a" slices
  __promptline_wrapper "$(__promptline_host) [`basename $VIRTUAL_ENV`]" "$slice_prefix" "$slice_suffix"&& { slice_prefix="$slice_joiner"; is_prompt_empty=0; }
...
function __promptline_left_prompt {
  ...
  [ $is_prompt_empty -eq 1 ] && slice_prefix="$slice_empty_prefix"
  # section "b" slices
  __promptline_wrapper "$HNAME [`basename $VIRTUAL_ENV`]" "$slice_prefix" "$slice_suffix" && { slice_prefix="$slice_joiner"; is_prompt_empty=0; }
